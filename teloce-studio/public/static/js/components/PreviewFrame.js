...
const __component = {
  ...
  template: `<section class="preview-frame" aria-label="Live preview"><slot></slot></section>`,
};
...
const __template = "<section class=\"preview-frame\" aria-label=\"Live preview\"><slot></slot></section>";
const __style = "";
...
const __installStyle = () => {
  ...
  const styleId = "teloce-style-ba9f81b42";
