...
const __component = {
  ...
  template: `<aside class="component-tree" aria-label="Component tree"><slot></slot></aside>`,
};
...
const __template = "<aside class=\"component-tree\" aria-label=\"Component tree\"><slot></slot></aside>";
const __style = "";
...
const __installStyle = () => {
  ...
  const styleId = "teloce-style-9718120d2";
