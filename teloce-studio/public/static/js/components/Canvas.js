...
const __component = {
  ...
  template: `<section class="editor-canvas" aria-label="Page canvas"><slot></slot></section>`,
};
...
const __template = "<section class=\"editor-canvas\" aria-label=\"Page canvas\"><slot></slot></section>";
const __style = "";
...
const __installStyle = () => {
  ...
  const styleId = "teloce-style-6ea5359e0";
