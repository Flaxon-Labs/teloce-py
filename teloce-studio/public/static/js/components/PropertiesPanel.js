...
const __component = {
  ...
  template: `<aside class="properties-panel" aria-label="Properties panel"><slot></slot></aside>`,
};
...
const __template = "<aside class=\"properties-panel\" aria-label=\"Properties panel\"><slot></slot></aside>";
const __style = "";
...
const __installStyle = () => {
  ...
  const styleId = "teloce-style-d52dcb9fe";
