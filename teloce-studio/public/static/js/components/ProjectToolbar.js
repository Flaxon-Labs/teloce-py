...
const __component = {
  ...
  template: `<header class="project-toolbar" aria-label="Project toolbar"><slot></slot></header>`,
};
...
const __template = "<header class=\"project-toolbar\" aria-label=\"Project toolbar\"><slot></slot></header>";
const __style = "";
...
const __installStyle = () => {
  ...
  const styleId = "teloce-style-2f4ca23f7";
